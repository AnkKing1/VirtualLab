...
export const registerStudent = async (req, res) => {
  const { name, email, password, confirmPassword, registrationNumber, department, semester } = req.body;

  try {
    // 1. Validate required fields
    if (!name || !email || !password || !confirmPassword || !registrationNumber || !department || !semester) {
